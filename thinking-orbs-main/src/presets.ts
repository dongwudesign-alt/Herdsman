...
export function resolvePreset(state: OrbState, size: OrbSize): Resolved {
  ...
  // Unknown sizes fall back to the inline-text preset (20px) tuning —
  // the canvas still renders at the requested size, just with the
  // closest tuned density/radius profile.
